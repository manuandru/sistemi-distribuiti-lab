...
public class TestExecutorAgentFSM {
    ...
    public TestExecutorAgentFSM(Integer i) {
        testIndex = i;
    }
    ...
    public void setUp() {
        rand = new Random();
        mas = Environment.executorBased(TestExecutorAgentFSM.class.getSimpleName() + "-Environment-" + testIndex);
    }
    ...
    public void testAgentsFlow() throws Exception {
        ...
        mas.registerAgent(new ExecutorBasedAgentFSM("Alice") {
            int x = 0;
    ...
    // TODO readme
    @Test
    public void testAgentsRunOnSameThread() throws Exception {
        ...
        mas.registerAgent(new ExecutorBasedAgentFSM("Bob") {
            @Override
            public void onRun() throws Exception {
    ...
    public void testAgentsPause() throws Exception {
        ...
        var bob = mas.registerAgent(new ExecutorBasedAgentFSM("Bob") {
